...
public class SpendingBill {
    ...
    public SpendingBill(int id, double spending_bill_amount, String spending_bill_category, int spending_bill_day, int spending_bill_month, int spending_bill_year) {
        this.id = id;
    ...
    @Ignore
    public SpendingBill(double spending_bill_amount, String spending_bill_category, int spending_bill_day, int spending_bill_month, int spending_bill_year) {
        this.spending_bill_amount = spending_bill_amount;
        this.spending_bill_category = spending_bill_category;
        this.spending_bill_day = spending_bill_day;
        this.spending_bill_month = spending_bill_month;
