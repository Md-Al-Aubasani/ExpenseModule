...
public class SpendingBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (position != -1){
            SpendingBill.spendingBills = databaseHelper.spendingBillDao().getAllSpendingBills();
        ...
        saveBtnSpendingBill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if (amount != null && date != "Date" && CategoryChosen != null){
                    databaseHelper.spendingBillDao().addSpendingBill(
                            new SpendingBill(amount, CategoryChosen, day, month, year)
                    );
